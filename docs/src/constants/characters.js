...
export const CHARACTER_CONFIGS = Object.freeze({
  ...
  [CHARACTER_IDS.AXION]: {
    ...
    animationFrameRanges: {
      ...
      spinAttack: { start: 0, end: 7 },
      specialAttack: { start: 0, end: 0 },
      hurt: { start: 0, end: 2 },
    ...
    animationTextures: {
      ...
      spinAttack: 'axion.thirdSkill',
      specialAttack: 'axion.idle',
      death: 'axion.death',
      hurt: 'axion.hurt',
    },
    attackLabels: {
      smash: 'Double Slash',
      spinAttack: 'Ground Breaker',
      thrust: 'Single Slash',
      specialAttack: 'Power Charge',
    },
    effects: {
      ...
      slashThickness: 10,
      slashFlatten: 0.72,
      powerChargeTextureKey: 'axion.powerCharge',
      powerChargeAnimation: { key: 'axion.powerCharge.loop', start: 0, end: 25, frameRate: 24 },
    },
    movementProfile: {
      dash: {
        durationMs: 170,
    ...
    combatProfile: {
      ...
      spinAttack: {
        damagePercentBonusMin: 0.20,
        damagePercentBonusMax: 0.24,
        sound: { key: 'smashAttack', volume: 1.08, triggerFrames: [5] },
        hitbox: {
          width: 174,
          height: 66,
          offsetX: 22,
        ...
        effectFrames: [
          { start: 5, end: 6, slashAngle: 4, sweepDirection: 1, slashRadius: 54, slashScale: 1.12 },
        ],
      },
      specialAttack: {
        mode: 'buff',
        ...
        hitCooldownMs: 260,
        tintDurationMs: 120,
        sound: { key: 'heavySmash', volume: 1.12 },
        cameraShake: {
          duration: 110,
          intensity: 0.007,
          onHitOnly: true,
        ...
        effectFrames: [
          { start: 0, end: 0, slashAngle: 0, sweepDirection: 1, slashRadius: 120, slashScale: 1.45 },
        ],
        uiLabels: {
          manaCost: '40 MP',
          range: '600 Shockwave',
          damage: 'Base + 5% (+0.7%/Lv) x 5 stacks',
        },
      },
    },
  },
